...
// Add to cart
if($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['product_id']) && !isset($_POST['update_qty'])) {
...
if(isset($_POST['update_qty'])) {
    ...
    if($qty <= 0) {
        ...
        if(!$stock || $stock['quantity'] <= 0) {
            ...
            $_SESSION['cart_error'] = '❌ Only ' . $stock['quantity'] . ' unit(s) available. Please update your quantity.';
        } else {
            $_SESSION['cart'][$product_id]['qty'] = $qty;
            unset($_SESSION['cart_error']);
...
<head>
    ...
    <style>
        ...
        .btn { display:inline-block; padding:12px 30px; background:#1976d2; color:white !important; text-decoration:none; border:none; border-radius:4px; cursor:pointer; font-size:16px; font-weight:bold; }
        .btn:hover { background:#1565c0; }
        .btn-secondary { background:#f5f5f5 !important; border:1px solid #ccc !important; color:#333 !important; }
